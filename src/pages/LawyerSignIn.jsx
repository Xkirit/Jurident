...
function LawyerSignIn() {
  ...
  return (
    <div className="min-h-screen">
      <Header />
      <div className="flex items-center justify-center text-white px-4 pt-20">
        {/* Main Container */}
        <div className="ml-24 flex flex-col md:flex-row items-center md:items-start w-full max-w-3xl space-x-6">
          ...
          <div className="p-5 rounded-lg shadow-lg w-full max-w-sm">
            ...
            {/* Join as Lawyer */}
            <h3 className="text-md font-medium text-yellow-400 text-center mt-3">Join as Lawyer</h3>
            ...
            <form className="space-y-3">
              ...
              <button onClick={() => navigate('/calendar')} className="w-full bg-blue-600 p-2.5 rounded-lg text-white font-medium hover:bg-blue-700 text-sm">Sign In</button>
            </form>

           
            <p className="text-center text-gray-400 mt-3 text-sm">
              Already have an account? <span className="text-yellow-500 cursor-pointer"><Link to="LawyerSignUp">Sign Up</Link> </span>
            </p>
          </div>
        </div>
      </div>
